;;; matlab-load.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...

;;; Generated autoloads from matlab-cell.el

(autoload 'matlab-cell-mode "matlab-cell" "\
...
`Matlab-Cell mode' mode.  If the prefix argument is positive,
...
evaluate `matlab-cell-mode'.

The mode's hook is called both when the mode is enabled and when
it is disabled.

\\{matlab-cell-mode-map}

(fn &optional ARG)" t)
(autoload 'matlab-cell-mode-enable "matlab-cell")
(autoload 'matlab-cell-mode-disable "matlab-cell")
(register-definition-prefixes "matlab-cell" '("matlab-cell-"))
